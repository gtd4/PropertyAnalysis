define(
    ...
    function (ko, koMap) {
        var PropertyDetailsViewModel = function (params) {
            ...
            _vm.loanType = ko.observableArray(["Principal and Interest"]);
            ...
            */
            _vm.calculatedRentToCoverInterest = ko.computed(function () {
                return Math.round(_vm.annualLoanCost() / (52));
            });
            ...
            */
            _vm.calculatedTotalExpense = ko.computed(function () {
                _vm.totalInitialExpense(_vm.initialRates() + _vm.initialRepairs() + _vm.initialInsurance() + _vm.bodyCorpFee());
            ...
            */
            _vm.calculatedRentToCoverMortgageAndExpenses = ko.computed(function () {
                return Math.round((_vm.totalInitialExpense() + _vm.annualLoanCost()) / (52));
            });
